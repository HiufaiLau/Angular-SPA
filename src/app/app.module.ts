...
//this is a typescript feature, for tepyscript to know where the things are.
...
@NgModule({
  ...
  //telling angular which component should you be aware of 
  //at the point of time the whole application starts. 
